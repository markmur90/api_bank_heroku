...
urlpatterns = [
    ...
    path('', listar_transferencias, name='listar_transferenciasGPT3'),  # Sin argumentos
    ...
    path('<str:payment_id>/cancelar/', cancelar_transferencia, name='cancelar_transferenciaGPT3'),
    ...
    path('<uuid:payment_id>/ver-log/', ver_log_transferencia, name='ver_log_transferenciaGPT3'),
    ...
    # OTP Retry
    path('<str:payment_id>/otp/', retry_second_factor_view, name='retry_second_factorGPT3'),

...
from api.gpt3.helpers import generate_deterministic_id, generate_payment_id, generate_payment_id_uuid, obtener_ruta_schema_transferencia
from api.gpt3.models import Account, Address, BulkTransfer, Creditor, Debtor, FinancialInstitution, InstructedAmount, PaymentIdentification, SepaCreditTransfer
from api.gpt3.forms import AccountForm, AddressForm, BulkTransferForm, CreditorForm, DebtorForm, FinancialInstitutionForm, GroupHeaderForm, InstructedAmountForm, PaymentIdentificationForm, PaymentInformationForm, SepaCreditTransferForm
from api.gpt3.schemas import sepa_credit_transfer_schema
from api.gpt3.utils import HEADERS, generar_otp_sepa_transfer, generar_pdf_transferencia, get_log_path, get_oauth_session, guardar_pain002_si_aplica, handle_error_response, obtener_otp, preparar_payload_transferencia, registrar_log, validar_xml_schema
...
def enviar_transferencia(request, payment_id):
    ...
    try:
        ...
        validate(instance=payload, schema=sepa_credit_transfer_schema)

...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('end_to_end_id', models.CharField(blank=True, default=uuid.uuid4, max_length=36, validators=[django.core.validators.RegexValidator(regex='^[a-zA-Z0-9.-]{1,36}$')])),
                ('instruction_id', models.CharField(blank=True, default=uuid.uuid4, max_length=36, validators=[django.core.validators.RegexValidator(regex='^[a-zA-Z0-9.-]{1,36}$')])),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_identification', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='sct.paymentidentification')),
            ],
            options={

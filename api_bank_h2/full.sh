...
if confirmar "Abrir Firefox para la aplicación Django-Local"; then
...
if confirmar "Abrir Firefox para la aplicación Django-Heroku"; then
    firefox --new-tab https://api-bank-heroku-72c443ab11d3.herokuapp.com/ &
fi

if confirmar "Abrir Firefox para el dashboard del honeypot-heroku"; then
    bash sudo ./honeypot_api.sh
    firefox --new-tab http://localhost:5001 &
fi

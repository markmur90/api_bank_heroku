...
class ChallengeRequestDataSecuritiesOrderSession(BaseModel):
    """
    challenge request data for requestType SECURITIES_ORDER_SESSION
    """ # noqa: E501
    type: StrictStr
    user_on_behalf_of: Optional[StrictStr] = Field(default=None, description="UserId to send a pushTAN to in case of a technical account", alias="userOnBehalfOf")
    __properties: ClassVar[List[str]] = ["type", "userOnBehalfOf"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'challengeRequestDataSecuritiesOrderSession',
            "userOnBehalfOf": obj.get("userOnBehalfOf")
        })
        return _obj

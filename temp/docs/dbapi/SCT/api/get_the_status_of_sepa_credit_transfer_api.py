...
class GetTheStatusOfSepaCreditTransferApi:
    ...
    def payment_id_status_get(
        ...
        _param = self._payment_id_status_get_serialize(
    ...
    @validate_call
    def payment_id_status_get_with_http_info(
        self,
        payment_id: Annotated[StrictStr, Field(description="Payment Id of Sepa Credit Transfer")],
        correlation_id: Annotated[Optional[Annotated[str, Field(strict=True, max_length=50)]], Field(description="Free form key controlled by the caller e.g. uuid")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def payment_id_status_get_without_preload_content(
        self,
        payment_id: Annotated[StrictStr, Field(description="Payment Id of Sepa Credit Transfer")],
        correlation_id: Annotated[Optional[Annotated[str, Field(strict=True, max_length=50)]], Field(description="Free form key controlled by the caller e.g. uuid")] = None,
        _request_timeout: Union[
    ...
    def _payment_id_status_get_serialize(
        self,
        payment_id,
        correlation_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{paymentId}/status',

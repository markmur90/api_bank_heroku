...
class SepaCreditTransferDetailsResponse(BaseModel):
    """
    ...
    purpose_code: Annotated[str, Field(min_length=4, strict=True, max_length=4)] = Field(description="ExternalPurpose1Code", alias="purposeCode")
    requested_execution_date: date = Field(description="must match yyyy-MM-dd format, also in CET timezone.", alias="requestedExecutionDate")
    debtor: Debtor
    ...
    remittance_information_structured: Annotated[str, Field(strict=True, max_length=140)] = Field(description="recommended to be used in each transaction ; contract related - references to the business; it depends on the client what they want to include", alias="remittanceInformationStructured")
    remittance_information_unstructured: Annotated[str, Field(strict=True, max_length=140)] = Field(description="recommended to be used in each transaction ; contract related : references to the business; it depends on the client what they want to include", alias="remittanceInformationUnstructured")
    __properties: ClassVar[List[str]] = ["transactionStatus", "paymentId", "purposeCode", "requestedExecutionDate", "debtor", "debtorAccount", "creditorAgent", "creditor", "creditorAccount", "paymentIdentification", "instructedAmount", "remittanceInformationStructured", "remittanceInformationUnstructured"]

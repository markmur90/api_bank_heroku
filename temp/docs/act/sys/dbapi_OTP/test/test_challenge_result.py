...
class TestChallengeResult(unittest.TestCase):
    """ChallengeResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChallengeResult:
        """Test ChallengeResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChallengeResult`
        """

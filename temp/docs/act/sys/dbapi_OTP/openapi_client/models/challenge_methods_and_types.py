...
class ChallengeMethodsAndTypes(BaseModel):
    """
    ChallengeMethodsAndTypes
    """ # noqa: E501
    methods: List[ChallengeMethodItem]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "methods": [ChallengeMethodItem.from_dict(_item) for _item in obj["methods"]] if obj.get("methods") is not None else None
        })
        return _obj

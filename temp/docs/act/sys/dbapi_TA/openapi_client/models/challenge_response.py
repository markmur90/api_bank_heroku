...
class ChallengeResponse(BaseModel):
    ...
    ChallengeResponse
    """ # noqa: E501
    challenge_response: StrictStr = Field(description="The TAN token to the created challenge. ", alias="challengeResponse")
    __properties: ClassVar[List[str]] = ["challengeResponse"]

...
class CreditorAgent(BaseModel):
    ...
    CreditorAgent
    """ # noqa: E501
    financial_institution_id: StrictStr = Field(alias="financialInstitutionId")
    __properties: ClassVar[List[str]] = ["financialInstitutionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "financialInstitutionId": obj.get("financialInstitutionId")
        })
        return _obj

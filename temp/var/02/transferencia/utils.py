...
from api_db_swift import settings, config
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                transaction.save()
                send_notification("user@example.com", "Swift Transfer Failed", f"Transaction {transaction.transaction_id} failed.")
                raise SwiftServerError("Transfer failed")
            
            transaction.status = 'COMPLETED'
            transaction.save()
            send_notification("user@example.com", "Swift Transfer Completed", f"Transaction {transaction.transaction_id} was successful.")

...
from api_db_swift2.config import BANCO_ORIGEN  # Importar el nombre del banco origen desde la configuración
...
def generar_pdf_transferencia(transferencia):
    ...
    detalles = [
        ...
        f"Fecha: {transferencia.fecha.strftime('%d/%m/%Y %H:%M:%S')}",  # Agregar la fecha de la transacción
    ]

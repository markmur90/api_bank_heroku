...
class UploadDocumentResponse(BaseModel):
    ...
    """ # noqa: E501
    document_reference_id: StrictStr = Field(description="ID referencing the uploaded document, to be used in ???/orders request.", alias="documentReferenceId")
    __properties: ClassVar[List[str]] = ["documentReferenceId"]

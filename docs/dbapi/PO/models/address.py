...
class Address(BaseModel):
    ...
    An postal address
    """ # noqa: E501
    street: StrictStr = Field(description="Street")
    house_number: StrictStr = Field(description="House number", alias="houseNumber")
    zip: StrictStr = Field(description="Zip code")
    city: StrictStr = Field(description="City")
    country: StrictStr = Field(description="Country")
    __properties: ClassVar[List[str]] = ["street", "houseNumber", "zip", "city", "country"]

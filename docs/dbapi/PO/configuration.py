...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "api_client_credential": OAuth2AuthSetting,
    },
    total=False,
)
...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://simulator-api.db.com:443/gw/dbapi/others/processingOrders/v2" if host is None else host
        """Default Base url
        """

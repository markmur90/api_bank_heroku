...
class DeleteSepaCreditTransferApi:
    ...
    def payment_id_delete(
        ...
        otp: Annotated[StrictStr, Field(description="One time password required for SCT cancellation, you can use photo tan or push tan. In case of push tan pass otp as 'PUSHTAN'. in case of photo tan please generate otp by using transaction authorisation APIs. there you must use requestType as 'SEPA_TRANSFER_CANCELLATION'.")],
        ...
        :param otp: One time password required for SCT cancellation, you can use photo tan or push tan. In case of push tan pass otp as 'PUSHTAN'. in case of photo tan please generate otp by using transaction authorisation APIs. there you must use requestType as 'SEPA_TRANSFER_CANCELLATION'. (required)
        :type otp: str
        ...
        _param = self._payment_id_delete_serialize(
    ...
    @validate_call
    def payment_id_delete_with_http_info(
        self,
        payment_id: Annotated[StrictStr, Field(description="Payment Id of Sepa Credit Transfer")],
        idempotency_id: Annotated[StrictStr, Field(description="Unique id of the service call. Must be present during retries to avoid multiple processing of the same request")],
        otp: Annotated[StrictStr, Field(description="One time password required for SCT cancellation, you can use photo tan or push tan. In case of push tan pass otp as 'PUSHTAN'. in case of photo tan please generate otp by using transaction authorisation APIs. there you must use requestType as 'SEPA_TRANSFER_CANCELLATION'.")],
    ...
    @validate_call
    def payment_id_delete_without_preload_content(
        self,
        payment_id: Annotated[StrictStr, Field(description="Payment Id of Sepa Credit Transfer")],
        idempotency_id: Annotated[StrictStr, Field(description="Unique id of the service call. Must be present during retries to avoid multiple processing of the same request")],
        otp: Annotated[StrictStr, Field(description="One time password required for SCT cancellation, you can use photo tan or push tan. In case of push tan pass otp as 'PUSHTAN'. in case of photo tan please generate otp by using transaction authorisation APIs. there you must use requestType as 'SEPA_TRANSFER_CANCELLATION'.")],
    ...
    def _payment_id_delete_serialize(
        self,
        payment_id,
        idempotency_id,
        otp,

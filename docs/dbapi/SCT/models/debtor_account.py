...
class DebtorAccount(BaseModel):
    ...
    DebtorAccount
    """ # noqa: E501
    iban: Annotated[str, Field(strict=True)] = Field(description="The IBAN of this account.")
    currency: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="ISO 4217 Alpha 3 currency code.")
    __properties: ClassVar[List[str]] = ["iban", "currency"]

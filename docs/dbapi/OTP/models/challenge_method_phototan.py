...
class ChallengeMethodPHOTOTAN(BaseModel):
    """
    ChallengeMethodPHOTOTAN
    """ # noqa: E501
    image_base64: StrictStr = Field(description="The base64 encoded PNG image that contains the challenge", alias="imageBase64")
    __properties: ClassVar[List[str]] = ["imageBase64"]

...
class ChallengeMethodMTAN(BaseModel):
    """
    ChallengeMethodMTAN
    """ # noqa: E501
    mobile_phone_number: StrictStr = Field(description="The telephone number the short message is being sent to", alias="mobilePhoneNumber")
    __properties: ClassVar[List[str]] = ["mobilePhoneNumber"]
